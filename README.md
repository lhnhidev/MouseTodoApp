...
* **Ngôn ngữ:** TypeScript
* *(Các thư viện UI, State management, Fetching data sẽ được bổ sung sau...)*

### Backend
* **Core:** .NET 10 (ASP.NET Core Web API)
* **Ngôn ngữ:** C# 12+
* *(Database, ORM, Logging sẽ được bổ sung sau...)*
...
*(Chèn hình ảnh sơ đồ Usecase tại đây)*

### 2. Sơ đồ dữ liệu khái niệm (CDM - Conceptual Data Model) - Sẽ bổ sung sau
*(Chèn hình ảnh sơ đồ CDM tại đây)*
